...
from the_speakeasy_bar._hooks import HookContext
...
class Ingredients:
    ...
    def list_ingredients(self, request: operations.ListIngredientsRequest) -> operations.ListIngredientsResponse:
        ...
        query_params = { **utils.get_query_params(operations.ListIngredientsRequest, request), **query_params }
        ...
        res = operations.ListIngredientsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
