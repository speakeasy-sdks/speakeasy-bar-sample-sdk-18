...
from the_speakeasy_bar._hooks import AfterErrorContext, AfterSuccessContext, BeforeRequestContext, HookContext
...
class Drinks:
    ...
    def get_drink(self, request: operations.GetDrinkRequest) -> operations.GetDrinkResponse:
        r"""Get a drink.
        ...
        res = operations.GetDrinkResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def list_drinks(self, request: operations.ListDrinksRequest, server_url: Optional[str] = None) -> operations.ListDrinksResponse:
        ...
        res = operations.ListDrinksResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
